...
- Работающий API-ключ Anthropic с пополненным балансом
- Smoke test, который доказывает что всё работает

Если на любом шаге застрял — пиши в [Telegram-канал «Работая в айтишечке»](https://t.me/workinginit), помогу разобраться.
